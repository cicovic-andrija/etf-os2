 ...
 *    dodati metodu 'std::recursive_mutex* getPoolSynchronizer()' u okviru klase System
 *    koja vraca recursive_mutex koji se koristi za sinhronizaciju ove niti i takodje
...
bool hit(System* system, Process* proc, VirtualAddress address, recursive_mutex* mtx, byte* data, bool execute)
{
...
bool hit(System* system, Process* proc, VirtualAddress address, recursive_mutex* mtx, byte* data)
{
